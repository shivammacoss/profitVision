...
const tradeSchema = new mongoose.Schema({
  ...
  // LP (Corecen) push tracking
  lpPushed: {
    type: Boolean,
    default: false  // Whether trade was pushed to Corecen LP
  },
  lpPushedAt: {
    type: Date,
    default: null  // When trade was pushed to LP
  },
  lpClosedAt: {
    type: Date,
    default: null  // When trade was closed on LP
  }
}, { timestamps: true })
