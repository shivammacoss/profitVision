...
const transactionSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['Deposit', 'Withdrawal', 'Transfer_To_Account', 'Transfer_From_Account', 'Account_Transfer_Out', 'Account_Transfer_In', 'Demo_Credit', 'Demo_Reset', 'IB_Entry_Fee', 'COPY_CREDIT_REFILL'],
    required: true
  },
  amount: {
    type: Number,
  ...
  // Description for system-generated transactions
  description: {
    type: String,
    default: ''
  },
  
  // Metadata for additional context (copy trading refills, etc.)
  metadata: {
