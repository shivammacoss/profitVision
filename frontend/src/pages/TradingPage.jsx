...
const TradingPage = () => {
  ...
  const closeTrade = async (tradeId) => {
    try {
      ...
      const bid = livePrice?.bid || instrument?.bid || 0
      const ask = livePrice?.ask || instrument?.ask || 0
      
      // Send request even without price - backend will try to fetch from LP cache
